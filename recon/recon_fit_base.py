...
class ReconFitterBase:
    ...
    def compute_pca_init(self, obj_name):
        ...
        seq_folder = self.seq_folder if use_custom_video(self.args) else None
        scan = load_template(obj_name, seq_folder=seq_folder) # load template from BEHAVE objects or InterCap objects
        self.scan = scan
        obj_verts = scan.v
