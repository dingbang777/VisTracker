...
from utils.custom_sequence import get_normalized_camera_params
...
class ReconFitterTriplane(ReconFitterBehave):
    ...
    def merge_configs(args, configs):
        ...
        configs.custom_video = args.custom_video
        if args.custom_video:
            configs.camera_params = get_normalized_camera_params(args.seq_folder, kid=args.tid, crop_size=configs.loadSize)
            print("Custom video camera parameters:", configs.camera_params)
