...
class MotionInfillTester:
    ...
    def prep_obj_rot6d(self, L, args, dat, file, seq_name):
        ...
        if args.neural_pca:
            ...
            seq_folder = args.seq_folder if getattr(args, "custom_video", False) and osp.isdir(args.seq_folder) else None
            temp = load_template(seq_name.split("_")[2], seq_folder=seq_folder)
