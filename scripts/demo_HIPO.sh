...
seq_name=$1
seq=demo_data/${seq_name}
recon_name="test-releasev2" # reconstruction save name

set -e

cp -r ../../data/demo_data/intermediate_process/${seq_name} demo_data
...
mkdir -p ../../data/demo_data/intermediate_process/${seq_name}/vistracker_result/recon_test-releasev2
mkdir -p ../../data/demo_data/intermediate_process/${seq_name}/vistracker_result/result-render
cp recon-all/recon_test-releasev2/${seq_name}_k1.pkl  ../../data/demo_data/intermediate_process/${seq_name}/vistracker_result/recon_test-releasev2
cp recon-all/result-render/${seq_name}/test-releasev2_w5000_side2side_0-None.mp4  ../../data/demo_data/intermediate_process/${seq_name}/vistracker_result/result-render/${seq_name}/test-releasev2_w5000_side2side_0-None.mp4